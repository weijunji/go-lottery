...
func TestUpdateLottery(t *testing.T) {
	...
	testData := []struct {
		...
		{`{"id":2, "title": "嘉年华plus", "description": "好礼相送", "permanent":5, "temporary":6, "startTime":"2020-02-27 15:04:05", "endTime":"2021-03-27 00:00:00"}`, http.StatusOK},
		...
		{`{"id":33, "title": "嘉年华plus2","description": "好礼相送","permanent":10,"temporary":6,"startTime":"2020-2-2 15:04:05","endTime":"2021-3-27 00:00:00"}`, http.StatusBadRequest},
	}
	for _, data := range testData {
		w := httptest.NewRecorder()
